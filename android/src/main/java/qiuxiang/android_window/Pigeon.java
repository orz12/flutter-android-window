        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                Long xArg = (Long) args.get(3);
                Long yArg = (Long) args.get(4);
                Boolean focusableArg = (Boolean) args.get(5);
                try {
                  api.open(entryArg, widthArg, heightArg, xArg, yArg, focusableArg);
                  wrapped.add(0, null);
                }
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long widthArg = (Long) args.get(0);
                Long heightArg = (Long) args.get(1);
                try {
                  api.resize(widthArg, heightArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long xArg = (Long) args.get(0);
                Long yArg = (Long) args.get(1);
                try {
                  api.setPosition(xArg, yArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
